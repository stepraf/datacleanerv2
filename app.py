...
from tabs import import_data, one_to_one, one_to_many, one_to_n_errors, relation_graph
...
# Create tabs
tab1, tab2, tab3, tab4, tab5 = st.tabs(["📥 Import Data", "1:1", "1:N", "1:N Errors", "Relation Graph"])
